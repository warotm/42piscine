...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2022/12/04 19:15:34 by wmakaran          #+#    #+#             */
/*   Updated: 2022/12/04 19:16:48 by wmakaran         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	check_31(char grid[6][6], int x, int y, char *iterstr)
{
	...
	if (grid[x][y] == '3' && grid[x + (iter[0] * 5)][y + (iter[1] * 5)] == '1')
	{
		if (grid[x + iter[0]][y + iter[1]] == '1')
			write_line(grid, x, y, concat("1324", iterstr));
